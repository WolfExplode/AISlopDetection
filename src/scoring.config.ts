...
export const RULE_SCORING: Record<string, { scoringMode: ScoringMode; freeRate: number }> = {
  'overused-intensifiers':    { scoringMode: 'diminishing', freeRate: 0 },
  ...
  'gerund-litany':            { scoringMode: 'threshold',   freeRate: 0.5 },
  ...
  'unicode-arrows':           { scoringMode: 'threshold',   freeRate: 0.5 },
  'dramatic-fragment':        { scoringMode: 'threshold',   freeRate: 0.5 },
  'concept-label':            { scoringMode: 'threshold',   freeRate: 0.5 },
  ...
  'historical-analogy':       { scoringMode: 'linear',      freeRate: 0 },
