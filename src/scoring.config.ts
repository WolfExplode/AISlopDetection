...
export const RULE_SCORING: Record<string, { ruleWeight: number; scoringMode: ScoringMode; freeRate: number; instanceWeight?: number; diminishingFactor?: number }> = {
  ...
  'quote-overuse':            { ruleWeight: 1.9, scoringMode: 'threshold',   freeRate: 0.5 },
  ...
  'parenthetical-qualifier':  { ruleWeight: 3.0, scoringMode: 'diminishing',   freeRate: 0, diminishingFactor: 0.86},
  ...
  'inline-emphasis':          { ruleWeight: 1.1, scoringMode: 'diminishing',   freeRate: 1.5, diminishingFactor: 0.95},
...
export const SLOP_WORDS_ESSAY: Record<string, number> = {
  ...
  'collaboratively': 0.62, 'commendable': 0.80, 'commodification': 0.82, 'commodified': 0.80, 'commoditization': 0.78,
  ...
  'misalignments': 0.55, 'monolithic': 0.62, 'monumental': 0.75, 'multifaceted': 0.85, 'multifactorial': 0.65,
  ...
  'scrutinizing': 0.55, 'seismic': 0.78, 'seamless': 0.72, 'shaping': 0.42, 'siloed': 0.58, 'silos': 0.55,
  ...
  'systemic': 0.45,
  'tailored': 0.55, 'tangible': 0.50, 'tapestry': 0.92, 'technological': 0.40, 'testament': 0.82, 'thirdly': 0.68,
