...
import {
  ...
  detectKnowledgeCutoffDisclaimer,
...
export function runClientDetectors(rawText: string): Violation[] {
  ...
  const all: Violation[] = [
    ...
    ...detectNegationPivotStructural(text),
    ...detectFragmentNegation(text),
    ...
    ...detectClassGeneralization(text),
    ...detectDecorativeMetaphor(text),
    ...detectBoldFirstBullets(text),
    ...detectUnicodeDecoration(text),
    ...detectDespiteChallenges(text),
    ...detectConceptLabel(text),
    ...detectDramaticFragment(text),
    ...detectPairedNegation(text),
    ...detectPhantomContrast(text),
    ...detectRealityClaim(text),
    ...detectSuperficialAnalysis(text),
    ...detectFalseRange(text),
    ...detectExemplarCliche(text),
    ...detectChatbotArtifact(text),
    ...detectKnowledgeCutoffDisclaimer(text),
    ...detectInlineEmphasis(text),
