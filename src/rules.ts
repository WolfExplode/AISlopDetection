...
export const RULES: ViolationRule[] = [
  ...
  },
  {
    ...
    category: 'rhetorical',
    description: 'Conversational scaffolding pasted into prose: "I hope this helps," "feel free to," "great question," "don\'t hesitate to ask."',
    ...
    requiresLLM: false,
    rewriteHint: 'Delete chatbot scaffolding ("I hope this helps", "feel free to", "great question") — they are conversational filler, not content.',
